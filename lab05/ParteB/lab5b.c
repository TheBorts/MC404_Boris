...
int main()
{
    ...
    */
    ...
    {
    case R:
        pack(data->funct7, 7, atual);
        pack(data->rs2, 5, atual);
        pack(data->rs1, 5, atual);
        pack(data->funct3, 3, atual);
        pack(data->rd, 5, atual);
        pack(data->opcode, 7, atual);
        break;
    case I:
        pack(data->imm, 12, atual);
        pack(data->rs1, 5, atual);
        pack(data->funct3, 3, atual);
        pack(data->rd, 5, atual);
        pack(data->opcode, 7, atual);
        break;
    case S:
        pack(data->imm >> 5, 7, atual);
        pack(data->rs2, 5, atual);
        pack(data->rs1, 5, atual);
        pack(data->funct3, 3, atual);
        pack(data->imm, 5, atual);
        pack(data->opcode, 7, atual);
    
        break;
    case B:
        pack(data->imm >> 12, 1, atual);
        pack(data->imm >> 5, 6, atual);
        pack(data->rs2, 5, atual);
        pack(data->rs1, 5, atual);
        pack(data->funct3, 3, atual);
        pack((data->imm >> 1), 4, atual);
        pack(data->imm >> 11, 1, atual);
        pack(data->opcode, 7, atual);
        break;
    case U:
        pack(data->imm, 20, atual);
        pack(data->rd, 5, atual);
        pack(data->opcode, 7, atual);
        break;
    case J:
        pack(data->imm >> 20, 1, atual);
        pack(data->imm >> 1, 10, atual);
        pack(data->imm >> 11, 1, atual);
        pack(data->imm >> 12, 8, atual);
        pack(data->rd, 5, atual);
        pack(data->opcode, 7, atual);
        break;
